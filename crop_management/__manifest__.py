...

{
    ...
    'version': '1.2',
    'website': 'https://simitechnologies.co.ke/crop-management',
    'category': 'Services/Crop Management',
    'sequence': 45,
    'summary': 'Organize and plan your farming',
    'depends': [
        'analytic',
        'base_setup',
        'mail',
    ...
    'assets': {
        'web.assets_backend': [
            'crop_management/static/src/css/project.css',
            'crop_management/static/src/utils/**/*',
            'crop_management/static/src/services/**/*',
            'crop_management/static/src/components/**/*',
            'crop_management/static/src/views/**/*',
            'crop_management/static/src/js/project_activity.js',
            'crop_management/static/src/js/project_control_panel.js',
            'crop_management/static/src/js/project_graph_view.js',
            'crop_management/static/src/js/project_pivot_view.js',
            'crop_management/static/src/js/project_rating_graph_view.js',
            'crop_management/static/src/js/project_rating_pivot_view.js',
            'crop_management/static/src/js/project_task_kanban_examples.js',
            'crop_management/static/src/js/tours/project.js',
            'crop_management/static/src/js/widgets/*',
            'crop_management/static/src/scss/project_dashboard.scss',
            'crop_management/static/src/scss/project_form.scss',
            'crop_management/static/src/scss/project_widgets.scss',
            'crop_management/static/src/xml/**/*',
        ],
        'web.assets_frontend': [
            'crop_management/static/src/scss/portal_rating.scss',
            'crop_management/static/src/scss/project_sharing_frontend.scss',
            'crop_management/static/src/js/portal_rating.js',
        ],
        'web.qunit_suite_tests': [
            'crop_management/static/tests/**/*.js',
        ],
        'web.assets_tests': [
            'crop_management/static/tests/tours/**/*',
        ],
        'crop_management.webclient': [
            ...
            'crop_management/static/src/components/crop_management_task_name_with_subtask_count_char_field/*',
            'crop_management/static/src/views/project_task_form/*.scss',

            'crop_management/static/src/project_sharing/search/favorite_menu/custom_favorite_item.xml',
            'crop_management/static/src/project_sharing/**/*',
